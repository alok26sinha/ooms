...
public class EdtCommodityTax  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v14", "EdtCommodityTax"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v14", "EdtTaxDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
