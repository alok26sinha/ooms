...
class IdentifierService {
	...
	def generateCompanyIdentifier() {
		def max = Company.createCriteria().get {
		    projections {
		        max "id"
		    }
		} as Integer 
	...
	def generateOrderIdentifier(int companyId) {
		
		def max = Order.createCriteria().get {
