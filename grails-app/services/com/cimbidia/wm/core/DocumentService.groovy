...
class DocumentService {
	...
	private getMessageTagLib() { 	
		return grailsApplication.mainContext.getBean('com.cimbidia.wm.MessageTagLib')
	}

	private getFormatTagLib() {
		return grailsApplication.mainContext.getBean('com.cimbidia.wm.FormatTagLib')
	}

	
	public File writeImage(com.cimbidia.wm.core.Document document) {
		File file
		try { 
	...
	public void scaleImage(com.cimbidia.wm.core.Document document, OutputStream outputStream, String width, String height) {
		File file
