...
import com.cimbidia.wm.product.ProductSearchCommand;
...
class RxNormController {
	...
	//	def data = "";
		...
		if (!rxnormApiKey) {
			throw new ApiException(message: "Your administrator must specify RxNorm API key (rxnorm.api.key) in configuration file (cimbidia-config.properties).  For more information, please go to <a href='http://rxnav.nlm.nih.gov/' target='_blank'>rxnav.nlm.nih.gov</a>.")
		}
