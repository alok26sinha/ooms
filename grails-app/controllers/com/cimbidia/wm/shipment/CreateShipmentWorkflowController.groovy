...
import com.cimbidia.wm.shipment.SendShipmentCommand;
...
import com.cimbidia.wm.shipment.ContainerType;
import com.cimbidia.wm.shipment.ReferenceNumber;
import com.cimbidia.wm.shipment.ReferenceNumberType;
...
class CreateShipmentWorkflowController {
    ...
    def createShipmentFlow = {
    	...
    	start {
    		action {
    		    	println "I AM HERE STATRTING SHIPMENT 1222 " + params
    	...
    	enterShipmentDetails {
    		on("next") {
    			bindData(flow.shipmentInstance, params)
    		    	println "I AM HERE WAHOOOOOOOOOOOO 1222 " + params
    		...
    		on("save") {
    		    	println "I AM HERE STATRTING to SAVE     SHIPMENT 1222 " + params
    			bindData(flow.shipmentInstance, params)
    	...
    	enterTrackingDetails {
    		...
    		on("next") {
    			 println "NOT SURE JOW A MA I I AM HERE STATRTING SHIPMENT 1222 " + params + " shipment = " + flow.shipmentInstance

    			bindData(flow.shipmentInstance, params)
    			 println "NOT SURE JOW A MA I I AM HERE STATRTING SHIPMENT 1222 " + params + " shipment,referenceNumbers = " + flow.shipmentInstance.referenceNumbers
    			...
    			// need to manually bind the reference numbers and shipper
     			...
     			if ( params.carrier?.id  ) {
     				def person = Person.get( params.carrier?.id )
     				flow.shipmentInstance.carrier = person
     			}
		...
		saveItemAction { 
			action { 
				try {
					...
					// FIXME Property [shipment] of class [class com.cimbidia.wm.shipment.ShipmentItem] cannot be null
