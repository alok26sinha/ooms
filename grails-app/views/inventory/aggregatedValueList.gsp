...
<html>
    ...
    <body>
    	...
    	<label class="pagetitle"><warehouse:message code="default.creates.label" args="[entityName]" default="Aggregated Inventory By Value View"/></label>
            ...
            <div class="list">
            	...
            	<tbody >
            		<tr class="prop odd">            
			            <g:form action="aggregatedValueList" method="post">
                ...
                <table  style="position: relative; top: 5px; width:50%">
                    ...
                    <g:while test="${(l < j)}">
	                     ...
	                     <tr class="even">
	                    	...
	                    	<g:each  in="${transInv.size() < 14 ? transInv : transInv.subList(m, n)}" var="inv" status="i">                                                 
	                        	 <td  ><g:link action="safetyStockAssociatedCost">${inv.itemLocation.product==null?"All":inv.itemLocation.product} </g:link></td>                        
	                     	</g:each>
	                     	<td> </td>
	                     </tr>
	                     <tr class="odd">
	                    	...
	                    	<g:each in="${transInv.size() < 14 ? transInv : transInv.subList(m, n)}" var="inv" status="i">                                                 
	                        	 <td ><g:link action="safetyStockAssociatedCost">${inv.itemLocation.location==null?"All":inv.itemLocation.location} </g:link></td>                        
	                     	</g:each>
	                     	<td></td>
	                     </tr>
	                     <tr  class="even">
