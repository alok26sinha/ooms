...
<g:link controller="stockCardEntry" action="create" params="['stockCard.id': stockCardInstance?.id]">${warehouse.message(code: 'default.add.label', args: [warehouse.message(code: 'stockCardEntry.label', default: 'StockCardEntry')])}</g:link>
