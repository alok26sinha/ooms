...
<html>
    <head>
        ...
        <g:set var="entityName" value="${warehouse.message(code: 'stockCard.label', default: 'Manage Stock Cards')}" />
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th><warehouse:message code="stockCard.product.label" default="Product" /></th>
                            <th><warehouse:message code="stockCard.action.label" default="Actions" /></th>
