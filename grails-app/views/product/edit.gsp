<%@ page import="com.cimbidia.wm.product.Product" %>
<html>
	<head>
                        ...
                        <div id="tabs-attributes" style="padding: 10px;" class="ui-tabs-hide">
                            <g:form action="update" method="post">
                                ...
                                <div class="box" >
                                    ...
                                    <g:set var="attributes" value="${com.cimbidia.wm.product.Attribute.list()}"/>
                                                ...
                                                <tr class="prop ${i%2?'even':'odd'}">
                                                    ...
                                                    <td>
                                                        ...
                                                        <g:select name="inventoryLevels[${i}].status"
                                                           from="${com.cimbidia.wm.inventory.InventoryStatus.list()}"
                                                ...
                                                <div class="center">
                                                    <span class="">
                                                        ...
                                                        <g:link class="create" controller="productPackage" action="create">Add product package</g:link>
                                                         --%>
                                                        <a href="javascript:void(0);" class="open-dialog create button icon add" dialog-id="createProductPackage"><warehouse:message code="package.add.label"/></a>
                                                    </span>
                                                    <span class="">
                                                        <a href="javascript:void(0);" class="open-dialog create button icon add" dialog-id="uom-dialog">Add UoM</a>
                                                    </span>
                                                    <span class="">
                                                        <a href="javascript:void(0);" class="open-dialog create button icon add" dialog-id="uom-class-dialog">Add UoM Class</a>
                                                    </span>
                                                </div>
                                            </td>
                                        </tr>
							...
							<g:form controller="unitOfMeasureClass" action="save" method="post">
								<table>
		                            ...
		                            <tr class="prop">
		                                ...
		                                <td valign="top" class="value ">
											<g:select name="type" from="${com.cimbidia.wm.core.UnitOfMeasureType.list() }" value="${packageInstance?.uom }" noSelection="['null':'']"></g:select>
							...
							<g:form controller="unitOfMeasure" action="save" method="post">
								<table>
		                            <tr class="prop">
		                                ...
		                                <td valign="top" class="value ">
											<g:select name="uomClass.id" from="${com.cimbidia.wm.core.UnitOfMeasureClass.list() }" optionValue="name" optionKey="id" value="${pacakageInstance?.uom }" noSelection="['null':'']"></g:select>
