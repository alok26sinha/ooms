	                        ...
	                        <tbody>
	                            ...
	                            <tr class="prop">
	                                ...
	                                <td valign="top" class="value ${hasErrors(bean: inventorySupplyInstance, field: 'inventorySupplyType', 'errors')}">
	                                    <g:select name="inventorySupplyType.id" from="${com.cimbidia.scm.oms.InventorySupplyType.list()}" optionKey="supplyType" value="${inventorySupplyInstance?.inventorySupplyType?.supplyType}" noSelection="['null': '']" />
	                                </td>
	                            </tr>
	                            ...
	                            <tr class="prop">
	                                ...
	                                <td valign="top" class="value ${hasErrors(bean: inventorySupplyInstance, field: 'inventoryIdentifier', 'errors')}">
	                                    <g:select name="inventoryIdentifier.id" from="${com.cimbidia.scm.oms.InventoryIdentifier.list()}" optionKey="id" value="${inventorySupplyInstance?.inventoryIdentifier?.tagNumber}"  />
	                                </td>
	                            </tr>
