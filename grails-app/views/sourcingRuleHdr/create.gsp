...
<html>
    ...
    <body >
    	...
    	<label class="pagetitle"><warehouse:message code="default.creates.label" args="[entityName]" default="Create Sourcing Rule"/></label>
	                ...
	                <table><td>
	                        ...
	                        <tbody>
	                            <tr class="prop">
	                                ...
	                                <td align="top" class="value ${hasErrors(bean: sourcingRuleHdrInstance, field: 'customer', 'errors')}">
										...
										valueId="${sourcingRuleHdr?.customer?.id }"
										valueName="${sourcingRuleHdr?.customer?.companyName }"
                    		...
                    		<table></tbody>
	                            ...
	                            <tr class="prop">
	                                ...
	                                <td valign="top" class="value ${hasErrors(bean: sourcingRuleHdrInstance, field: 'product', 'errors')}">
	                                    ...
	                                    <g:select name="product.id" from="${com.cimbidia.wm.product.Product.list()}" optionKey="id" value="${sourcingRuleHdrInstance?.product?.id}"  noSelection="['':'']"/>
	                                </td>
	                            </tr>
	                            ...
	                            <tr class="prop">
	                                ...
	                                <td valign="top" class="value ${hasErrors(bean: sourcingRuleHdrInstance, field: 'productClass', 'errors')}">
	                                   <g:selectPC name="productClass.id" optionKey="id"
	                    ...
	                    <tr><td>
	                        ...
	                        <div valign="top" class="value ${hasErrors(bean: sourcingRuleHdr, field: 'sourcingRuleDtl', 'errors')}">
						       ...
						       <g:render template="sourcingRuleDtls" model="['sourcingRuleHdr':sourcingRuleHdr]" />
	                   ...
	                   <table>
	                    <tbody> 
		                        ...
		                        <tr class="prop">
		                        	...
		                        	<td valign="top">
						                <div class="buttons">
						                   <g:submitButton name="save" class="save" value="${warehouse.message(code: 'default.button.create.label', default: 'Save')}" />
