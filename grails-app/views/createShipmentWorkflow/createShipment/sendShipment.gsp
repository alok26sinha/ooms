						...
						<table>
							<tbody>
								...
								<tr class="prop">
									...
									<td valign="top" class="value">
										<span class="fade">
											<format:metadata obj="${com.cimbidia.wm.shipment.ShipmentStatusCode.CREATED}"/>
										</span>
										&nbsp;
										...
										&nbsp;
										<span>
											<b><format:metadata obj="${com.cimbidia.wm.shipment.ShipmentStatusCode.SHIPPED}"/></b>
										</span>
										&nbsp;
										<img src="${createLinkTo(dir:'images/icons/silk',file: 'arrow_right.png')}" style="vertical-align: middle"/>
										&nbsp;
										<span class="fade">
											<format:metadata obj="${com.cimbidia.wm.shipment.ShipmentStatusCode.RECEIVED}"/>
										</span>
									</td>
								</tr>
								--%>
