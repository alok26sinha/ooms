...
<tr class="prop">
	...
	<td valign="top" class="value">
		...
		<g:select name="weightUnits" from="${com.cimbidia.wm.core.Constants.WEIGHT_UNITS}" value="${container ? container?.weightUnits : box?.weightUnits}" />	
	</td>
</tr>
<tr class="prop">
	<td valign="top" class="name">
	...
	<td valign="top" class="value">
		...
		<g:select name="volumeUnits" from="${com.cimbidia.wm.core.Constants.VOLUME_UNITS}" value="${container ? container?.volumeUnits : box?.volumeUnits}" />	
