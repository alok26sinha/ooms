...
<html>
    ...
    <div class="content_inner">
    	...
    	<label class="pagetitle"><warehouse:message code="default.creates.label" args="[entityName]" default="Edit Allocation Rule"/></label>
        ...
        <div class="body">
            ...
            <input type="hidden" name='id' value="${allocationRuleInstance?.id?.encodeAsHTML()}"/>
            	<fieldset>
	                <div class="dialog">
	                    
	                        
	                           <table class="allocationTable" style="z-index:1;">
	                        	 <tr class="prop">
	                                <td valign="top" class="name" style="color:blue;">
	                                    <warehouse:message code="allocationRule.description.label" default="Description" />
	                                </td>
	                          ...
	                          <tr><td colspan="8" valign="bottom" style="color:blue;" >Inventory Considerations</td></tr>
	                            <tr  class="prop" style="height:60px">
	                                ...
	                                <td valign="top" style="width:50px;"class="value ${hasErrors(bean: allocationRuleInstance, field: 'applyFutureSafetyFactor', 'errors')}">
	                                 ...
	                                 --%><td valign="top" class="name" style="white-space: nowrap;text-align: left;">
	                                    <label for="applyOnHandSafetyFactor"><warehouse:message code="allocationRule.honorPriorCommmittments.label" default="Honor Prior Committments" /></label>
	                                </td>
	                        ...
	                        <table class="allocationTable" rules="rows">
		                        <tr class="prop" colspan="2" valign="bottom">
		                        	...
		                        	<td valign="top">
						                <div class="buttons">
						                   <g:submitButton name="create" class="save" value="${warehouse.message(code: 'default.button.saves.label', default: 'Save')}" />
