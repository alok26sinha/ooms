...
<div id="shipment-action-menu" class="action-menu">
    ...
    --%>
        ...
        <g:if test="${shipmentInstance.isPending()}">
            <g:isUserInRole roles="[com.cimbidia.wm.core.RoleType.ROLE_CARRIER]">
                <div class="action-menu-item">
                    <g:link controller="shipment" action="acceptShipment" id="${shipmentInstance.id}">
                        <img src="${createLinkTo(dir: 'images/icons/silk', file: 'pencil.png')}" class="middle"/>&nbsp;
                        <g:if test="${request.request.requestURL.toString().contains('acceptShipment')}">
                            <warehouse:message code="shipping.acceptShipment.label"/>
                        </g:if>
                        <g:else><warehouse:message code="shipping.acceptShipment.label"/></g:else>
                    </g:link>
                </div>
            </g:isUserInRole>
        </g:if>
