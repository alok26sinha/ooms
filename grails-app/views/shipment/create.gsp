	 		...
	 		<g:if test="${addLocation}">
           	...
           	<g:form action="save" method="post" autocomplete="off">
				...
				--%><g:hiddenField name="id" value="${shipmentInstance?.id}"/>
					...
					<div class="createShipmentHeader"><label style="color:white"><warehouse:message code="shipping.createShipmentHeader.label"/></label></div>
					<div class="dialog box">
               		...
               		<tr>
               			...
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'status','errors')}'>
										...
										<input type="text" name='shipmentStatus' value="Pending" size="25" readonly="readonly" />
						</td>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'masterBOL','errors')}'>
										...
										<input type="text" name='masterBOL' value="${shipmentInstance?.masterBOL?.encodeAsHTML()}" size="25" />
						</td>
               		</tr>
               		<tr>
               			...
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'transResp','errors')}'>
										...
										<input type="text" name='transResp' value="${shipmentInstance?.transResp?.encodeAsHTML()}" size="25" />
						</td>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'carrier','errors')}'>
										...
										<input type="text" name='carrier' value="${shipmentInstance?.carrier?.firstName?.encodeAsHTML()}" size="25" />
						</td>
               		</tr>
               		<tr>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'pos','errors')}'>
										...
										<input type="text" name='pos' value="${shipmentInstance?.pos?.encodeAsHTML()}" size="25" />
						</td>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'cos','errors')}'>
										...
										<input type="text" name='name' value="${shipmentInstance?.cos?.encodeAsHTML()}" size="25"/>
						</td>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'tos','errors')}'>
										...
										<input type="text" name='tos' value="${shipmentInstance?.tos?.encodeAsHTML()}" size="25"/>
						</td>
               		</tr>
               		<tr>
               			...
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'billTo','errors')}'>
										...
										<input type="text" name='billTo' value="${shipmentInstance?.billTo?.encodeAsHTML()}" size="25"/>
						</td>
               		</tr>
               		<tr>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'productClass','errors')}'>
										...
										<input type="text" name='productClass' value="${shipmentInstance?.productClass?.encodeAsHTML()}" size="25"/>
						</td>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'tempCtrl','errors')}'>
										...
										<input type="text" name='tempCtrl' value="${shipmentInstance?.tempCtrl?.encodeAsHTML()}" size="25"/>
						</td>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'isPerish','errors')}'>
										...
										<input type="text" name='isPerish' value="${shipmentInstance?.isPerish?.encodeAsHTML()}" size="25" />
						</td>
               		</tr>
               		<tr>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'equipment','errors')}'>
										...
										<input type="text" name='equipment' value="${shipmentInstance?.equipment?.encodeAsHTML()}" size="25" />
						</td>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'trailerId','errors')}'>
										...
										<input type="text" name='trailerId' value="${shipmentInstance?.trailerId?.encodeAsHTML()}" size="25" />
						</td>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'tractorId','errors')}'>
										...
										<input type="text" name='tractorId' value="${shipmentInstance?.tractorId?.encodeAsHTML()}" size="25" />
						</td>
               		</tr>
               		<tr>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'sealNumber','errors')}'>
										...
										<input type="text" name='sealNumber' value="${shipmentInstance?.sealNumber?.encodeAsHTML()}" size="25" />
						</td>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'ShipmentType','errors')}'>
               							<label for='mode'><warehouse:message code="shipping.mode.label"/></label>
               							</td><td>
										<g:select name="shipmentType.id" from="${com.cimbidia.wm.shipment.ShipmentType.list()}" optionKey="id" optionValue="${{format.metadata(obj:it)}}" value="${orderCommand?.shipmentType?.id }" noSelection="['':'-Choose designated mode-']"/>
               		...
               		<tr>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'shipper','errors')}'>
										...
										<input type="text" name='shipper' value="${shipmentInstance?.shipper?.encodeAsHTML()}" size="25"/>
						</td>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'seller','errors')}'>
										...
										<input type="text" name='seller' value="${shipmentInstance?.seller?.encodeAsHTML()}" size="25" />
						</td>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'payMethod','errors')}'>
										...
										<input type="text" name='payMethod' value="${shipmentInstance?.payMethod?.encodeAsHTML()}" size="25" />
						</td>
               		</tr>
               		<tr>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'shipmentPrice','errors')}'>
										...
										<input type="text" name='shipmentPrice' value="${shipmentInstance?.shipmentPrice?.encodeAsHTML()}" size="25" />
						</td>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'carrierPrice','errors')}'>
										...
										<input type="text" name='carrierPrice' value="${shipmentInstance?.carrierPrice?.encodeAsHTML()}" size="25" />
						</td>
               		...
               		<tr>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'pickupStart','errors')}'>
										...
										<input type="text" name='pickupStart' value="${shipmentInstance?.pickupStart?.encodeAsHTML()}" size="25"/>
						</td>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'pickupEnd','errors')}'>
										...
										<input type="text" name='pickupEnd' value="${shipmentInstance?.pickupEnd?.encodeAsHTML()}" size="25"/>
						</td>
               		...
               		<tr>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'timeOfDeparture','errors')}'>
										...
										<input type="text" name='timeOfDeparture' value="${shipmentInstance?.timeOfDeparture?.encodeAsHTML()}" size="25" />
						</td>
               			<td valign='top' style="" class='value ${hasErrors(bean:shipmentInstance,field:'timeOfArrival','errors')}'>
										...
										<input type="text" name='timeOfArrival' value="${shipmentInstance?.timeOfArrival?.encodeAsHTML()}" size="25" />
						</td>
