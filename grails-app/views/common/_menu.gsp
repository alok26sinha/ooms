...
<div id="leftnav-accordion-menu" class="accordion menu">	
	...
	<g:authorize activity="[ActivityCode.PLACE_ORDER,ActivityCode.FULFILL_ORDER]">	
		...
		<div class="menu-section">
			<ul>
				...
				<%-- 
				<g:each in="${com.cimbidia.wm.order.Order.executeQuery('select o.status, count(*) from Order as o where o.destination = ? group by o.status', [session?.warehouse])}" var="orderStatusRow">
					<li>
	...
	--%><g:authorize activity="[ActivityCode.SEND_STOCK]">
		...
		<div class="menu-section">
			<ul>
				...
				<%-- 
				<g:each in="${com.cimbidia.wm.shipment.Shipment.findAllByOrigin(session?.warehouse).groupBy{it.status.code}.sort()}" var="statusRow">
					<li>
						<span class="menuButton submenuItem">
	...
	<g:authorize activity="[ActivityCode.RECEIVE_STOCK]">		
		...
		<div class="menu-section">
			<ul>
				...
				<%-- 
				<g:each in="${com.cimbidia.wm.shipment.Shipment.findAllByDestination(session?.warehouse).groupBy{it.status.code}.sort()}" var="statusRow">
					<li>
						<span class="menuButton submenuItem">
	...
	<div class="menu-section">
		...
		<ul>
			...
			<li>
				<span class="menuButton">
					<g:link controller="equipment" action="list"><warehouse:message code="equipment.label"/></g:link>
				</span>
			</li>
		</ul>
