...
<header class="navbar navbar-default" style="margin-bottom: 1px; min-height: 10p" >


        <div class="form-inline">
             <div class="pull-left">

<div class="btn navbar" style="margin-bottom: 2px">
        	...
        	<span><warehouse:message code="default.cimbidia.label"/></span>
             ...
             <div class="pull-right">
					    ...
					    <g:if test="${session.user}">
                            ...
                            <li>
                                <div class="dropdown" >
                                    <button class="btn dropdown-toggle btn-success btn" style="padding: 0px 45px" data-toggle="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                        ...
                                        --%>
                                        <li class="action-menu-item">
                                            <a id="fullscreen-button" href="#">Full Screen</a>
                                        </li>
                                        <li class="action-menu-item">
