...
<%@ page import="com.cimbidia.wm.product.Category" %>
<html>
    <head>
            ...
            <div class="yui-u first">
                ...
                <%--
                   <table>
                    ...
                    <g:each var="category" in="${com.cimbidia.wm.product.Category.list().sort() { it?.categories?.size() }.reverse() }" status="status">
