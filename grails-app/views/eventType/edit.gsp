...
<%@ page import="com.cimbidia.wm.core.EventType" %>
<html>
    <head>
	                        ...
	                        <tbody>
	                            ...
	                            <tr class="prop">
	                                ...
	                                <td valign="top" class="value ${hasErrors(bean: eventTypeInstance, field: 'eventCode', 'errors')}">
	                                    <g:select name="eventCode" from="${com.cimbidia.wm.core.EventCode?.values()}" value="${eventTypeInstance?.eventCode}" noSelection="['': '']" />
	                                </td>
	                            </tr>
	                            ...
	                            <tr class="prop">
	                                ...
	                                <td valign="top" class="value ${hasErrors(bean: eventTypeInstance, field: 'activityType', 'errors')}">
	                                    <g:select name="activityType" from="${com.cimbidia.wm.core.ActivityType?.values()}" value="${eventTypeInstance?.activityType}" noSelection="['': '']" />
	                                </td>
	                            </tr>
	                            ...
	                            <tr class="prop">
	                                ...
	                                <td valign="top" class="value ${hasErrors(bean: eventTypeInstance, field: 'eventType', 'errors')}">
	                                    <g:select name="eventType" from="${com.cimbidia.wm.core.EventTypes?.values()}" value="${eventTypeInstance?.eventType}"  />
	                                </td>
	                            </tr>
