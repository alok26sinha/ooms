												...
												<tr class="prop">
													...
													<td class="value middle">
														<div class="middle">
															...
															in
															1 
															<g:select name="packages[0].uom.id" from="${com.cimbidia.wm.core.UnitOfMeasure.list() }" optionValue="name" optionKey="id" value="${pacakageInstance?.uom }" noSelection="['null':'']"></g:select>
