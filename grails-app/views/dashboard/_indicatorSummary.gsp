...
<div class="panel panel-primary">
	...
	<h5><warehouse:message code="dashboard.indicators.label" default="KPIs"/></h5>
	</div>	    			
	<div class="widget-content" style="padding:0; margin:0">	    					    			
		<div id="indicatorSummary">
    		...
    		<table>
    			<tbody>
                    <g:each in="${com.cimbidia.wm.reporting.Indicator.list()}" var="indicator" status="status">
                    ...
                    <g:unless test="${com.cimbidia.wm.reporting.Indicator.list()}">
                        <tr>
                            <td >
