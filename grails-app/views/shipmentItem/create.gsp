...
<%@ page import="com.cimbidia.wm.shipment.ShipmentItem" %>
<html>
    <head>
	                        ...
	                        <tbody>
	                            ...
	                            <tr class="prop">
	                                ...
	                                <td valign="top" class="value ${hasErrors(bean: shipmentItemInstance, field: 'container', 'errors')}">
	                                    <g:select name="container.id" from="${com.cimbidia.wm.shipment.Container.list()}" optionKey="id" value="${shipmentItemInstance?.container?.id}" noSelection="['null': '']" />
	                                </td>
	                            </tr>
	                            ...
	                            <tr class="prop">
	                                ...
	                                <td valign="top" class="value ${hasErrors(bean: shipmentItemInstance, field: 'product', 'errors')}">
	                                    <g:select name="product.id" from="${com.cimbidia.wm.product.Product.list()}" optionKey="id" value="${shipmentItemInstance?.product?.id}"  />
	                                </td>
	                            </tr>
	                            ...
	                            <tr class="prop">
	                                ...
	                                <td valign="top" class="value ${hasErrors(bean: shipmentItemInstance, field: 'recipient', 'errors')}">
	                                    <g:select name="recipient.id" from="${com.cimbidia.wm.core.Person.list()}" optionKey="id" value="${shipmentItemInstance?.recipient?.id}" noSelection="['null': '']" />
	                                </td>
	                            </tr>
	                            ...
	                            <tr class="prop">
	                                ...
	                                <td valign="top" class="value ${hasErrors(bean: shipmentItemInstance, field: 'inventoryItem', 'errors')}">
	                                    <g:select name="inventoryItem.id" from="${com.cimbidia.wm.inventory.InventoryItem.list()}" optionKey="id" value="${shipmentItemInstance?.inventoryItem?.id}" noSelection="['null': '']" />
	                                </td>
	                            </tr>
	                            ...
	                            <tr class="prop">
	                                ...
	                                <td valign="top" class="value ${hasErrors(bean: shipmentItemInstance, field: 'receiptItem', 'errors')}">
	                                    <g:select name="receiptItem.id" from="${com.cimbidia.wm.receiving.ReceiptItem.list()}" optionKey="id" value="${shipmentItemInstance?.receiptItem?.id}" noSelection="['null': '']" />
	                                </td>
	                            </tr>
	                            ...
	                            <tr class="prop">
	                                ...
	                                <td valign="top" class="value ${hasErrors(bean: shipmentItemInstance, field: 'donor', 'errors')}">
	                                    <g:select name="donor.id" from="${com.cimbidia.wm.donation.Donor.list()}" optionKey="id" value="${shipmentItemInstance?.donor?.id}" noSelection="['null': '']" />
	                                </td>
	                            </tr>
	                            ...
	                            <tr class="prop">
	                                ...
	                                <td valign="top" class="value ${hasErrors(bean: shipmentItemInstance, field: 'shipment', 'errors')}">
	                                    <g:select name="shipment.id" from="${com.cimbidia.wm.shipment.Shipment.list()}" optionKey="id" value="${shipmentItemInstance?.shipment?.id}"  />
	                                </td>
	                            </tr>
