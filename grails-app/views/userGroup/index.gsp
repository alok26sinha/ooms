		...
		<div id="list-userGroup" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="userGroup.groups.label" default="Groups" /></th>
					
						<th><g:message code="userGroup.user.label" default="User" /></th>
				...
				<g:each in="${userGroupInstanceList}" status="i" var="userGroupInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${userGroupInstance.id}">${fieldValue(bean: userGroupInstance, field: "groups")}</g:link></td>
