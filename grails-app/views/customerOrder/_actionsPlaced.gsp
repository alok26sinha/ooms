<g:if test="${orderInstance?.id }">
	<div class="actions" style="min-width: 200px;">
		...
		<div class="action-menu-item">	
				<g:link name="markOrderReadyToShip" controller="order" action="markReadyToShip" id="${orderInstance?.id}">
					<img src="${resource(dir: 'images/icons/silk', file: 'lorry.png')}" />
					&nbsp;${warehouse.message(code: 'order.markReadyToShip.label')} 
				</g:link>				
		</div>	
		<div class="action-menu-item">	
				<g:link name="createTransportationOrder" controller="order" action="createTransportationOrder" id="${orderInstance?.id}">
					<img src="${resource(dir: 'images/icons/silk', file: 'lorry.png')}" />
					&nbsp;${warehouse.message(code: 'order.createTransportationOrder.label')} 
				</g:link>				
		</div>
		<div class="action-menu-item">
