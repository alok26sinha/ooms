<g:if test="${orderInstance?.id }">
	<div class="actions" style="min-width: 200px;">
		...
		<div class="action-menu-item">
			<g:link controller="order" action="edit" id="${orderInstance?.id}">
		...
		<div class="action-menu-item">
			<g:link controller="order" action="edit" id="${orderInstance?.id}" params="['skipTo': 'items']">
		...
		<div class="action-menu-item">
			<g:link controller="order" action="duplicateOrder" id="${orderInstance?.id}" onclick="return confirm('${warehouse.message(code: 'default.button.duplicate.confirm.message', default: 'Are you sure?')}');">
				<img src="${resource(dir: 'images/icons/silk', file: 'bin.png')}" />
				&nbsp;${warehouse.message(code: 'order.duplicateOrder.label')} 
			</g:link>				
		</div>
		<div class="action-menu-item">
