...
<div class="envelope" >
		...
		<div class="content_inner"><label class="pagetitle"><warehouse:message code="co.editco.label"/></label></div>
			
			<input type="hidden" name='id' value="${customerOrderInstance?.id?.encodeAsHTML()}"/>
				<fieldset>
<div class="right">
            		...
            		<table>
						<tbody>
						<tr>
						<td style=""><label for='orderNumber'><warehouse:message code="co.coNumber.label"/></label></td>
						<td><input type="text" name='orderNumber' value="${customerOrderInstance?.orderNumber?.encodeAsHTML()}" size="25" readonly="readonly"/></td>
						...
						<td><input type="text" name='status' value="${customerOrderInstance?.status}"  size="25" readonly="readonly"/></td>
						...
						<tr>
								...
								<td>
								<input type="text" name="earliestRequestedDate" id="earliestRequestedDate" value="${formatDate(format:'MM/dd/yyyy', date:customerOrderInstance?.earliestRequestedDate )}">
							...
							<tr>
								...
								<td style=""><label for='orderSource'><warehouse:message
											code="co.orderSource.label" /></label></td>
					...
					<td><label for='customerContact'><warehouse:message code="co.cContact.label" /></label></td>
						<td><input type="text" name='customerContact' value="${customerOrderInstance?.customerContact?.encodeAsHTML()}"
								size="25" />
					</td>
					...
					<td><label for='creditCardNumber'><warehouse:message code="co.creditCard.label" /></label></td>
						...
						<tr>
						<td><label for='customerPoNumber'><warehouse:message code="co.customerPO.label" /></label></td>
						<td>
						<input type="text" name='customerPoNumber'
								value="${customerOrderInstance?.customerPoNumber?.encodeAsHTML()}"
								size="25" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<label for=''><warehouse:message code="co.relatedPO.label" /></label>
...
class="section-header"><b><warehouse:message code="co.billingAdds.label" /></b></label>
								...
								<table style="border: 1px solid lightgrey">
									<tr>
										...
										<td>
											...
											id="origin-value" class="value" type="hidden" value="${customerOrderInstance?.origin?.id}"
											name="origin"> <input id="billToAddress.id"
											class="value" type="hidden" value="${customerOrderInstance?.billToAddress?.id}" name="billToAddress.id">
											...
											$(this).val(""); // set the value in the textbox to empty strings
								...
								<table style="border: 1px solid lightgrey">
									<tr>
										...
										--%> <span id="destination-span" class="span"
											style="text-align: left; display: none;"></span> <input
											id="destination-value" class="value" type="hidden" value="${customerOrderInstance?.destination?.id}"
											name="destination"> <input id="toAddress.id"
											class="value" type="hidden" value="${customerOrderInstance?.toAddress?.id}" name="toAddress.id">
											<span class="ui-helper-hidden-accessible" role="status"
						...
						<table>
							<tr>
								...
								<td>
					<label class="section-header" for='lineitems'><warehouse:message code="default.lineitems.label" default="Line Items"/></label>								<td/>
							</tr>
					</table>
						<table>										
						<tr class="prop">
						   ...
						   <td valign="top" class="dtl-header">
							...
							<table>
						  		<tr valign="top" class="value ${hasErrors(bean: customerOrderInstance, field: 'orderItems', 'errors')}">
							       <!-- Render the orderItems template (_orderItems.gsp) here -->
							       <g:render template="orderItemsEdit" model="['customerOrderInstance':customerOrderInstance]" />
							       <!-- Render the orderItems template (_orderItems.gsp) here -->
							   	</tr>
						...
						<tr class="prop">
		                        	...
		                        	<td valign="top">
						                <div class="action-menu" >
											<g:render template="actionsEdit" model="[customerOrderInstance:customerOrderInstance]"/>
										</div>                 	
		                        	</td>
		                        </tr>
						</table>				
...
<script>
	   <g:remoteFunction controller="message" action="setReceipient" params="{companyId:${customerOrderInstance?.customer?.id}}" />
	   </script>
