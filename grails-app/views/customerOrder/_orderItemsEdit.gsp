<script type="text/javascript">
    var itemChildCount = ${customerOrderInstance?.orderItems?.size()} + 0;
...
<div style="float:right;margin-left:98%"><input type='button' value="Add Item" onclick="addOrderItem();" /></div>
