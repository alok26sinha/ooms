...
<html>
	...
	<body>
		<a href="#list-groups" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-groups" class="content scaffold-list" role="main">
			...
			<thead>
				...
				<g:each in="${groupsInstanceList}" status="i" var="groupsInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${groupsInstance.id}">${fieldValue(bean: groupsInstance, field: "description")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate total="${groupsInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
