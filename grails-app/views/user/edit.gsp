<%@ page import="com.cimbidia.wm.core.*" %>
				...
				<div>
	                <div class="dialog">
                        ...
                        <div class="yui-g">
					     ...
					     <tr class="prop">
						<td valign="top" class="name">
						    <label for="email"><warehouse:message code="user.carrier.label" /></label>
						</td>
						<td valign="top" class="value ${hasErrors(bean: userInstance, field: 'warehouse', 'errors')}">
						    <g:select name="shipper.id" from="${com.cimbidia.wm.shipment.Shipper.list()?.sort()}"
							      optionKey="id" value="${userInstance?.shipper?.id}" noSelection="['null':'']"/>
						</td>
					    </tr>
                                            ...
                                            <g:isUserAdmin>
                                                ...
                                                <tr class="prop">
                                                    ...
                                                    <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'roles', 'errors')}">
                                                        ...
                                                        <g:select name="roles" from="${com.cimbidia.wm.core.Role.list()?.sort({it.description})}" optionKey="id" value="${userInstance?.roles}" noSelection="${['null': noAccessLabel]}" multiple="true"/>
                                                    </td>
                                                </tr>
                                            </g:isUserAdmin>
                                            <tr class="prop">
                                                ...
                                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'warehouse', 'errors')}">
                                                    <g:select name="warehouse.id" from="${com.cimbidia.wm.core.Location.list()?.sort()}"
