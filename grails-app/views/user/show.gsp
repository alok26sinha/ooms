...
<body>
	<div class="body">
		...
		<g:if test="${flash.message}">
			...
			<tr class="prop">
                            <td valign="top" class="name"><label><warehouse:message
                                    code="user.carrier.label" /></label></td>
                            <td valign="top" class="value">
                                <g:if test="${userInstance?.shipper}">
                                    ${fieldValue(bean: userInstance, field: "shipper")}
                                </g:if>
                                <g:else>
                                    <span class="fade">
                        ...
                        <tr class="prop" id="locationRoles">
                             ...
                             <td valign="top" class="value">
                                 <g:if test="${userInstance?.locationRoles}">
                                    <%=userInstance?.locationRoles?.collect{ it.location?.name + '[' + it.role + ']' }.join(", ")%>	
                                 </g:if>
                                 <g:else>
