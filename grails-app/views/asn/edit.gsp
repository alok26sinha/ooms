...
.dialog td{
        ...
        <div class="body">
            ...
            <g:form method="post" >
            	<fieldset>
	                ...
	                <g:hiddenField name="version" value="${asnInstance?.version}" />
	                <div class="dialog">
	                    <table>
	                        <tbody>
	                        		                            <tr class="prop">
	                    	...
	                    	<td colspan="2"><label class="section-header">
								...
								<table>
									<tr>
										...
										<td style="padding:0px;">
											<%--<g:selectOrderSupplier name="destination.id" optionKey="id" value="${asnInstance?.shipDestination?.id}" noSelection="['':'-Choose destination location-']"/>
		   ...
		   <td valign="top" class="dtl-header" style="padding:0px">
		      <label for="asnItems"><g:message code="asnItem.Item.label" default="Item" /></label>
		   </td>
		  <td valign="top" class="dtl-header"  style="padding:0px">
			...
			<td valign="top" class="dtl-header" style="padding:0px"></td>
	      	...
	      	<div valign="top" class="value ${hasErrors(bean: asnInstance, field: 'asnItems', 'errors')}">
		       ...
		       <g:render template="asnItemsEdit" model="['asnInstance':asnInstance]" />
    ...
    <g:render template='asnItemEdit' model="['asnItem':null,'i':'_clone','hidden':true]"/>
    <!-- Render the asnItem template (_asnItem.gsp) hidden so we can clone it -->
    </body>
</html>
