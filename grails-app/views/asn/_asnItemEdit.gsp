<div id="asnItem${i}" class="asnItem-div" <g:if test="${hidden}">style="display:none;"</g:if>>
    ...
    <div class="dtl">
    <g:selectOrder name="asnItems[${i}].order.id" optionKey="id" value="${asnItem?.order?.id}" noSelection="['':'']" />																  
	</div>
    <div class="dtl">
    <g:selectItem name="asnItems[${i}].orderItem.id" optionKey="id" value="" noSelection="['':'']" />	<!-- {asnItem?.orderItem?.id} -->															  
	</div>
    <div class="dtl">
