...
import com.cimbidia.wm.log4j.net.DynamicSubjectSMTPAppender
...
grails {
	mail { 		
		...
		// ${user.home}/cimbidia-config.properties file 
		enabled = true			
		from = ""
		prefix = "[cimbidia]" + "["+GrailsUtil.environment+"]"
		host = "localhost"
		port = "25"
	}
}
...
cimbidia.loginLocation.requiredActivities = ["MANAGE_INVENTORY"]
...
//grails.views.gsp.keepgenerateddir="/home/abc/git/cimbidia/target/generated"
...
grails.validateable.packages = [
	'com.cimbidia.wm.inventory', 
	'com.cimbidia.wm.fulfillment',
	'com.cimbidia.wm.order', 
	'com.cimbidia.wm.request',
	'com.cimbidia.wm.shipment',
	'com.cimbidia.wm.booking'
]
...
mail.error.from = ''
mail.error.to = ''
mail.error.subject = '[cimbidia]['+GrailsUtil.environment+']'
...
log4j = {
	...
	/*appenders {
		rollingFile name:'catalinaOut', maxFileSize:1024, fileName:"c/project/catalina.outt"
file name: 'stacktrace', file: "c/project/catalina.out", layout: pattern(conversionPattern: '%c{2} %m%n')
	}
 ...
 */
grails.doc.title = "cimbidia"
grails.doc.subtitle = ""
grails.doc.authors = "abc"
...
xmpp.username="admin"
xmpp.password="tigase"
xmpp.connection.host="192.168.1.10"
xmpp.connection.port=5222
xmpp.connection.service="server2"
