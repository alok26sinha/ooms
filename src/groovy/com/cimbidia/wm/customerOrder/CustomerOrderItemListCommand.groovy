...
@Validateable
class CustomerOrderItemListCommand implements Serializable {
	...
	def orderItems = 
		LazyList.decorate(new ArrayList(), FactoryUtils.instantiateFactory(CustomerOrderItemCommand.class));
