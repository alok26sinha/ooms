describe("requisitionItem",function(){
    it("should get quantity picked, remaining and status from requisition item", function(){
      var requisitionItem = new cimbidia.requisition.RequisitionItem({id: "1234", quantity:5000});
      //expect(requisitionItem.status()).toBe("Incomplete");
      var picklistItem1 = new cimbidia.requisition.PicklistItem({
        quantity: 1000,
        quantityOnHand: 2000
      });
      ...
      var picklistItem2 = new cimbidia.requisition.PicklistItem({
        quantity: 4000,
        quantityOnHand: 4000
      });
