   ...
   describe("should find newer version between two requisition picklist objects", function(){
     ...
     describe("version at picklistlevel always wins", function(){
       ...
       it("there is no local data", function(){
        ...
        expect(cimbidia.requisition.Picklist.getNewer(serverData, null)).toBe(serverData);
      });
      ...
      it("server data is newer", function(){
        ...
        expect(cimbidia.requisition.Picklist.getNewer(serverData, localData)).toBe(serverData);
      });
      ...
      it("local data is newer", function(){
        ...
        expect(cimbidia.requisition.Picklist.getNewer(serverData, localData)).toBe(localData);
      });
